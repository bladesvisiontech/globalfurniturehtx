...
export default function AboutPage() {
  return (
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {VALUES.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white rounded-2xl p-8 shadow-sm text-center">
                <div className="w-14 h-14 bg-[#E7E0CE]/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Icon className="text-[#00253D]" size={24} />
                </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-start gap-3">
                <MapPin size={20} className="text-[#1E3331] shrink-0 mt-0.5" />
                <div>
              ...
              <li className="flex items-center gap-3">
                <Phone size={20} className="text-[#1E3331] shrink-0" />
                <a href={siteData.phoneUrl} className="font-semibold text-[#00253D] hover:underline">
                  {siteData.phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Clock size={20} className="text-[#1E3331] shrink-0 mt-0.5" />
                <p>{siteData.hours}</p>
              </li>
            </ul>
            <div className="flex gap-3 mt-8">
              <a
                ...
                className="bg-[#1E3331] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#2a4745] transition-colors flex items-center gap-2"
              >
              ...
              <a
                ...
                className="border-2 border-[#00253D] text-[#00253D] font-bold px-6 py-3 rounded-xl hover:bg-[#00253D] hover:text-white transition-colors flex items-center gap-2"
              >
      ...
      {/* CTA */}
      <section className="bg-[#00253D] text-white py-12 text-center">
        <h2 className="text-2xl font-bold mb-3">Ready to Furnish Your Home?</h2>
        <p className="text-white/70 mb-6">Browse our full catalog or visit us in person.</p>
        <div className="flex justify-center gap-4 flex-wrap">
          <Link href="/shop" className="bg-[#1E3331] text-white font-bold px-8 py-3 rounded-xl hover:bg-[#2a4745] transition-colors">
            Shop Now
          </Link>
