...
const inputClass = "w-full px-4 py-3 text-sm text-[#7DA68B] font-light bg-white focus:outline-none transition-colors"
const inputStyle = { border: '1px solid #ECEAE4', borderRadius: 0 }
const focusStyle = "focus:border-[#7DA68B]"
  ...
  if (status === 'success') {
    return (
      <div className="bg-[#F5F2EC] p-10 text-center" style={{ border: '1px solid #ECEAE4' }}>
        <CheckCircle className="text-[#0e2b62] mx-auto mb-4" size={36} />
        <h3 className="text-xl font-light text-[#7DA68B] mb-2">Message Sent</h3>
        <p className="text-[#7DA68B]/50 text-sm font-light">We&apos;ll be in touch shortly. Or call us at <a href="tel:+18328515250" className="text-[#7DA68B] font-medium">832-851-5250</a>.</p>
        <button onClick={() => setStatus('idle')} className="mt-6 text-xs tracking-widest uppercase text-[#0e2b62] font-medium hover:text-[#7DA68B] transition-colors">Send another →</button>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label className="block text-[10px] tracking-widest uppercase text-[#7DA68B]/40 mb-1.5 font-medium">Name *</label>
        ...
        <div>
          <label className="block text-[10px] tracking-widest uppercase text-[#7DA68B]/40 mb-1.5 font-medium">Phone *</label>
      ...
      <div>
        <label className="block text-[10px] tracking-widest uppercase text-[#7DA68B]/40 mb-1.5 font-medium">Email</label>
      ...
      <div>
        <label className="block text-[10px] tracking-widest uppercase text-[#7DA68B]/40 mb-1.5 font-medium">Interested In</label>
      ...
      <div>
        <label className="block text-[10px] tracking-widests uppercase text-[#7DA68B]/40 mb-1.5 font-medium">Message</label>
      ...
      <button type="submit" disabled={status === 'loading'} className={cn('w-full flex items-center justify-center gap-2 text-sm font-medium text-white bg-[#7DA68B] py-4 transition-opacity', status === 'loading' ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-90')}>
