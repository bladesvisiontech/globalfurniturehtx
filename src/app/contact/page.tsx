      ...
      <section className="max-w-screen-xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <ul className="space-y-8 mb-10">
              <li className="flex items-start gap-4">
                <div className="w-9 h-9 bg-[#E7E0CE] flex items-center justify-center shrink-0">
                  <Phone className="text-[#0e2b62]" size={15} />
                </div>
                <div>
                  <p className="text-[10px] tracking-widest uppercase text-[#0e2b62]/40 mb-1 font-medium">Phone</p>
                  <a href={siteData.phoneUrl} className="text-lg font-light text-[#0e2b62] hover:text-[#0e2b62] transition-colors">{siteData.phone}</a>
                  <p className="text-xs text-[#0e2b62]/40 font-light mt-0.5">Call or text during business hours</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-9 h-9 bg-[#E7E0CE] flex items-center justify-center shrink-0">
                  <MapPin className="text-[#0e2b62]" size={15} />
                </div>
                <div>
                  <p className="text-[10px] tracking-widest uppercase text-[#0e2b62]/40 mb-1 font-medium">Showroom</p>
                  <a href={siteData.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="text-sm font-light text-[#0e2b62]/70 hover:text-[#0e2b62] transition-colors leading-relaxed block">
              ...
              <li className="flex items-start gap-4">
                <div className="w-9 h-9 bg-[#E7E0CE] flex items-center justify-center shrink-0">
                  <Clock className="text-[#0e2b62]" size={15} />
                </div>
                <div>
                  <p className="text-[10px] tracking-widest uppercase text-[#0e2b62]/40 mb-1 font-medium">Hours</p>
          ...
          <div id="quote">
            ...
            <p className="text-[#0e2b62]/40 text-sm font-light mb-8">Fill out the form and we&apos;ll get back to you shortly.</p>
