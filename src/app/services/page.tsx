    ...
    <div>
      ...
      <section className="max-w-screen-xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-[#E7E0CE] flex items-center justify-center">
                <Truck className="text-[#0e2b62]" size={18} />
              </div>
            ...
            <p className="text-[#0e2b62]/60 font-light text-sm leading-relaxed mb-8">
            ...
            <ul className="space-y-3 mb-10">
              {DELIVERY_FEATURES.map((f) => (
                <li key={f} className="flex items-center gap-3 text-sm text-[#0e2b62]/70 font-light">
          ...
          <div className="bg-[#F5F2EC] p-12 text-center" style={{ border: '1px solid #ECEAE4' }}>
            ...
            <p className="text-[#0e2b62]/50 text-xs font-light mb-6 leading-relaxed">Order before noon and we&apos;ll deliver the same day in most Houston-area locations.</p>
            <p className="text-xs text-[#0e2b62]/30 mb-4">Call to confirm availability for your area</p>
            <p className="text-[#0e2b62] font-semibold">{siteData.phone}</p>
          </div>
        </div>
      </section>
      ...
      <section id="financing" className="bg-[#F5F2EC]" style={{ borderTop: '1px solid #ECEAE4', borderBottom: '1px solid #ECEAE4' }}>
        <div className="max-w-screen-xl mx-auto px-6 py-20">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-[#E7E0CE] flex items-center justify-center">
              <CreditCard className="text-[#0e2b62]" size={18} />
            </div>
          ...
          <p className="text-[#0e2b62]/50 font-light text-sm mb-12 max-w-lg">We partner with three leading no-credit-needed financing companies to help you get the furniture you need today, and pay over time.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {FINANCING_PARTNERS.map((partner) => (
              <div key={partner.name} className="bg-white p-8" style={{ border: '1px solid #ECEAE4' }}>
                ...
                <p className="text-[#0e2b62]/50 text-xs font-light leading-relaxed mb-6">{partner.description}</p>
                <ul className="space-y-2 mb-8">
                  {partner.features.map((f) => (
                    <li key={f} className="flex items-center gap-2 text-xs text-[#0e2b62]/70 font-light">
          ...
          <div className="mt-10 bg-[#0e2b62] text-white p-10 text-center">
            ...
            <a href={siteData.phoneUrl} className="text-sm font-medium text-[#0e2b62] bg-white px-8 py-3 hover:bg-[#E7E0CE] transition-colors flex items-center gap-2 w-fit mx-auto" style={{ borderRadius: 25 }}>
      ...
      <section className="max-w-screen-xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-[#0e2b62]/50 text-sm font-light mb-8">Browse our catalog and find your perfect furniture today.</p>
